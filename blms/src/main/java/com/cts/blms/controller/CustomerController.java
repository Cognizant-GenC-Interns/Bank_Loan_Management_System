...
public class CustomerController {
	...
	public String registerCustomer(@Valid @ModelAttribute("customer") Customer customer,
			@RequestParam("panCard") MultipartFile panCard, @RequestParam("profile_image") MultipartFile profileImage,
			@RequestParam("salarySlip") MultipartFile salarySlip, BindingResult result) throws IOException {
		if (result.hasErrors()) {
	...
	public String updateCustomerProfile(@Valid @ModelAttribute("loggedCustomer") Customer customer,
