...
public class LoanProductServiceImpl implements LoanProductService {
	...
	public LoanProduct updateLoanProduct(LoanProduct loan) {
		...
		LoanProduct existingProduct = loanProductRepository.findById(Long.valueOf(loan.getLoanProductId()))
				.orElseThrow(() -> new RuntimeException("Loan Product not found with ID: " + loan.getLoanProductId()));
		if (loan.getProductName() != null)
			existingProduct.setProductName(loan.getProductName());
		if (loan.getInterestRate() != null)
			existingProduct.setInterestRate(loan.getInterestRate());
		if (loan.getMinAmount() != null)
			existingProduct.setMinAmount(loan.getMinAmount());
		if (loan.getMaxAmount() != null)
			existingProduct.setMaxAmount(loan.getMaxAmount());
		if (loan.getTenure() != null)
			existingProduct.setTenure(loan.getTenure());
	...
	public void deleteLoanProduct(Long loanProductId) {
		LoanProduct existingProduct = loanProductRepository.findById(Long.valueOf(loanProductId))
				.orElseThrow(() -> new RuntimeException("Loan Product not found with ID: " + loanProductId));
