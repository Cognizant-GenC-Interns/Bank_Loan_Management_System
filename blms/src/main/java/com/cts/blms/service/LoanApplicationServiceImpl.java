...
//		repaymentService.createRepayment(loanApplication);
//		return repository.save(loanApplication);
//	}
//
//	
...
public class LoanApplicationServiceImpl implements LoanApplicationService {
	...
	public LoanApplication rejectLoan(Long id) {
		...
		LoanApplication loanApplication = repository.findById(id)
											.orElseThrow(() -> new RuntimeException("Loan Application not found with ID: " + id)); // Use orElseThrow for robustness
	...
	public LoanApplication getLoanApplicationById(Long id) {
		...
		return repository.findById(id)
						.orElseThrow(() -> new RuntimeException("Loan Application not found with ID: " + id)); // Use orElseThrow
	}
	...
	public LoanApplication approveLoan(Long id, LocalDate approveDate) {
		...
		LoanApplication loanApplication = repository.findById(id)
											.orElseThrow(() -> new RuntimeException("Loan Application not found with ID: " + id)); // Find loan, throw if not found
